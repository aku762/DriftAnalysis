...
class Analysis():    
    ...
    def training(self, family=None, additional_months=False, specific_family=None):
        ...
        if additional_months:
            ...
            selected_indexes += self.family_selection_from_index(self.initial_test[34],[specific_family])
            selected_indexes += self.family_selection_from_index(self.initial_test[35],[specific_family])
            selected_indexes += self.family_selection_from_index(self.initial_test[36],[specific_family])
